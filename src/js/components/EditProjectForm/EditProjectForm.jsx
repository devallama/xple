...
import { projectEdit } from 'Actions/project-actions';
    ...
    render() {
        return (
            <Form fields={this.fields} className="form form--login" multiSubmit={true} noValidate
                submitMethod={this.props.projectEdit} afterSubmitMethod={this.props.toggleEditForm}>
                <h1>Edit project</h1>
                ...
                <ResetButton className="btn btn--warn btn--upper weight--light form__btn"
                    fn={this.props.toggleEditForm}
                >
                    Cancel
                </ResetButton>
                <button type="submit" className="btn btn--primary btn--upper weight--light form__btn">Edit</button>
            </Form>
        );
    }
}
...
export default connect(mapStateToProps, { projectEdit })(EditProjectForm);